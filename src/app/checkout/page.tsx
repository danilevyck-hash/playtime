...
import { CONTACT, CREDIT_CARD_SURCHARGE } from '@/lib/constants';
      ...
      {step === 4 && whatsappUrl && (
        <div className="max-w-md mx-auto text-center space-y-6">
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 w-full bg-[#25D366] hover:bg-[#20bd5a] text-white font-heading font-bold text-lg py-4 px-6 rounded-2xl transition-colors shadow-lg animate-pulse"
          >
