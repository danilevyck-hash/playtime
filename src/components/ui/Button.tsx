...
const variants = {
  primary: 'bg-orange-solid text-white hover:bg-orange-solid/90 shadow-sm',
...
export default function Button({
  ...
  return (
    <button
      className={`font-heading font-semibold rounded-full transition-all duration-200 inline-flex items-center justify-center gap-2 disabled:bg-gray-200 disabled:text-gray-400 disabled:shadow-none disabled:cursor-not-allowed focus:outline-none focus-visible:ring-2 focus-visible:ring-purple focus-visible:ring-offset-2 ${variants[variant]} ${sizes[size]} ${className}`}
      {...props}
    >
      {children}
    </button>
