    ...
    <footer className="bg-purple text-white pb-safe">
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <h3 className="font-heading font-bold text-lg mb-3">{'\u00bf'}Tienes preguntas?</h3>
            <a href={`https://wa.me/${contact.whatsapp}`} target="_blank" rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-[#25D366] text-white font-heading font-semibold px-5 py-2.5 rounded-full text-sm hover:bg-[#20bd5a] mb-4">
            ...
            <div className="flex items-center gap-3">
              <a href={`https://wa.me/${contact.whatsapp}`} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/10 hover:bg-white/20 rounded-full flex items-center justify-center" aria-label="WhatsApp">
              ...
              <a href="https://instagram.com/playtimekids" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/10 hover:bg-white/20 rounded-full flex items-center justify-center" aria-label="Instagram">
              ...
              <a href="mailto:playtimekidspty@gmail.com" className="w-10 h-10 bg-white/10 hover:bg-white/20 rounded-full flex items-center justify-center" aria-label="Email">
